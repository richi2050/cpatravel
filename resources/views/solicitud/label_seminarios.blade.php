...
<div class="container">
        ...
        <div class="col-md-8">
            <table class="table">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="numero_de_eventos" id="numero_de_eventos" class="txt-re-col form-control">
                    </td>
                    <td>
                        Total costo
                    </td>
                    <td>
                        <input type="text" name="total_costo" id="total_costo" class="txt-re-col form-control" placeholder="$">
                    </td>
                </tr>
            </table>
        </div>
    ...
    <div class="row">
       <div class="col-md-2">
           <span class="icon-seminarios elemento-eti">
                ...
                if(parseFloat($valor) > parseFloat($('#monto_company_policies_id').val())){
                    ...
                    $.ajax({
                        ...
                        success:function(data){
                            ...
                            window.parent.seminarios(datas,data.data.iden);
                            window.parent.blurStuff(0);
                            return data;
                        },
                        error:function(data){
